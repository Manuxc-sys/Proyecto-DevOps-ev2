...
// 💡 CONFIGURAMOS LA VARIABLE DE ENTORNO PARA DESPACHOS (Puerto local: 8082)
// Si está en AWS, tomará la IP inyectada por el pipeline. En tu PC usará localhost.
...
export const TableDespachos = () => {
  ...
  const despacho = async () => {
    // 💡 REEMPLAZAMOS LA URL FIJA POR LA VARIABLE DINÁMICA CON COMILLAS INVERTIDAS (``)
    await axios.get(`${API_DESPACHOS_URL}/api/v1/despachos`, {
        headers:{
