...
// 💡 CONFIGURAMOS LA VARIABLE DE ENTORNO PARA VENTAS (Puerto local: 8081)
// Si está en AWS, el pipeline le inyectará la IP del servidor. Si estás en tu PC, usará localhost.
